<template>
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-select v-model="category_id"  clearable placeholder="商品分类" class="filter-item" style="width: 130px">
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      ...
      <el-table-column prop="productCate.name" label="分类名称" />
      <el-table-column prop="retail_price" label="商品价格" />
...
export default {
  ...
  methods: {
    ...
    beforeInit() {
      ...
      const sort = 'id,desc'
      this.params = { page: this.page, size: this.size, sort: sort, is_show: 0, isDel: 0,category_id: this.category_id  }
