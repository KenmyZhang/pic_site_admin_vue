<template>
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-select v-model="category_id"  clearable placeholder="商品分类" class="filter-item" filterable :filter-method="dataFilter" style="width: 130px">
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      ...
      <el-table-column ref="table" prop="primary_pic_url" label="图片">
        <template slot-scope="scope">
          <a :href="scope.row.primary_pic_url" style="color: #42b983" target="_blank"><img :src="scope.row.primary_pic_url" alt="点击打开" class="el-avatar"></a>
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    beforeInit() {
      ...
      const sort = 'id,desc'
      this.params = { page: this.page, size: this.size, sort: sort, is_show: 1, isDel: 0,category_id: this.category_id  }
    ...
    attr(data) {
      ...
      _this.form = {
        ...
        merId: data.merId,
        image: data.image,
        card_id: parseInt(data.card_id)||0,
        sliderImage: data.sliderImage,
        storeName: data.storeName,
        storeInfo: data.storeInfo,
        keyword: data.keyword,
