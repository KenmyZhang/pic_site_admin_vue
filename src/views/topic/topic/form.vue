  ...
  <div class="app-container">
    <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
      ...
      <el-form-item label="封面">
        <single-pic v-model="form.scene_pic_url"  type="image" :num="1" :width="150" :height="150" />
        <!-- <MaterialList v-model="form.image" style="width: 370px" type="image" :num="1" :width="150" :height="150" /> -->
      </el-form-item>
      <el-form-item label="价格信息">
        <el-input v-model="form.price_info" style="width: 370px;" rows="5" type="textarea" />
      </el-form-item>
...
<script>
import { add, edit, get } from '@/api/topic/yxTopic'
  ...
  methods: {
    ...
    doAdd() {
      add(this.form).then(res => {
       ...
       // this.$parent.init()
        setTimeout(() => {
          this.$router.push({ path: '/topic/topic' });
        }, 500);
      }).catch(err => {
        this.loading = false
