...
import Vue from 'vue'
import { edit } from '@/api/shop/StoreOrder'
    ...
    crudMethod: {
      ...
      edit: (form) => {
        return new Promise(function(resolve, reject) {
          edit({ 'id': form.id, 'remark': form.remark, 'shipper_code': form.shipper_code, 'shipper_name': form.shipper_name, 'logistic_code': form.logistic_code, 'order_price': Number(form.order_price), 'order_status': form.order_status }).then(res => {
            resolve()
          })
        })
      },
    ...
    refresh() {
      ...
      return new Promise((resolve, reject) => {
        ...
        initData(crud.url, crud.getQueryParams()).then(data => {
          console.log('a:' + data.data.totalElements)
